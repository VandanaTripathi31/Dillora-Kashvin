...
export default function AdminCategories() {
  ...
  const removeSub = async (catId, subId) => {
    if (!confirm('Remove this sub-category? Products already in it stay, but the tab disappears.')) return;
  ...
  return (
    <div className="adm__pad">
      ...
      <p className="muted" style={{ marginTop: 18, fontSize: 13 }}>
        Note: sub-categories you add are saved on this device for now. Once the backend is connected, they’ll be shared everywhere automatically.
      </p>
    </div>
  );
}
