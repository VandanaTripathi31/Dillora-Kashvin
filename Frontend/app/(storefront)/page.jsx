...
export default function Home() {
  ...
  useEffect(() => {
    api.getBestsellers(8).then(setBest);
  }, []);
        ...
        <div className="container hero__inner">
          <div className="hero__copy">
            <span className="hero__eyebrow">
              <Sparkles /> Handmade in India · Made to order
            </span>
            <h1 className="hero__title">
              Little things,
              <br />
              <span className="hero__title-italic">made with love.</span>
            </h1>
            <p className="hero__sub">
              Phone covers, charms, crochet &amp; resin art — each piece crafted
              by hand, just for you. Find something that feels like yours.
            </p>
            <div className="hero__cta">
              <Link href="/c/mobile-covers" className="btn btn-primary btn-lg">
                Shop the collection
              </Link>
              <Link href="/c/resin-art" className="btn btn-ghost btn-lg">
                Explore Resin Art
              </Link>
            </div>
          ...
          <div className="hero__art" aria-hidden="true">
            ...
            <div className="hero__badge hero__badge--made">
              🧶 100% Handmade
            </div>
          </div>
        </div>
      ...
      <section className="craft" id="about">
        <div className="container craft__inner">
          <Reveal className="craft__media shine-img">
            <img
              src="/images/crochet/coin-pouch/d1.png"
              alt="Handmade crochet piece by Dillora by Kashvin"
              title="Handmade crochet piece by Dillora by Kashvin"
            />
          </Reveal>
          <Reveal className="craft__copy" delay={120}>
            ...
            <p>
              Dillora by Kashvin began with a simple idea — that the little
              things we carry every day should feel personal. Each piece is
              shaped slowly, by hand — poured, stitched, beaded and finished
              with care. No mass production, no shortcuts. Just little things
              made with a lot of love.
            </p>
            <ul className="craft__points">
              <li>
                <span className="craft__ico">
                  <Sparkles />
                </span>{" "}
                Hand-poured, stitched &amp; beaded in-house
              </li>
              <li>
                <span className="craft__ico">
                  <Heart />
              ...
              <li>
                ...
                Lovingly packed &amp; delivered pan-India
              </li>
            </ul>
            <Link href="/about" className="btn btn-primary craft__btn">
              See how it&apos;s made <ArrowRight />
            </Link>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container stats-band__grid">
          ...
          <div className="stat-item">
            <span className="stat-item__num">
              4.8<span className="stat-item__star">★</span>
            </span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-10 py-10">
          {[
            ...
            <div key={title} className="flex flex-col gap-1">
              <strong className="font-display text-[1.05rem] text-orchid-600">
                {title}
              </strong>
...
const CAT_THEME = {
  "mobile-covers": {
    panel: "linear-gradient(135deg,#faf5fe 0%,#f3e9fb 100%)",
    border: "rgba(166,79,214,.16)",
    blob: "rgba(166,79,214,.22)",
    accent: "#7a2c98",
    bar: "linear-gradient(90deg,#a64fd6,#7a4ff0)",
  },
  "mobile-charms": {
    panel: "linear-gradient(135deg,#fdf5fb 0%,#fbe6f3 100%)",
    border: "rgba(229,127,196,.20)",
    blob: "rgba(229,127,196,.24)",
    accent: "#a32c83",
    bar: "linear-gradient(90deg,#e57fc4,#a64fd6)",
  },
  crochet: {
    panel: "linear-gradient(135deg,#f6f2fe 0%,#ece4fd 100%)",
    border: "rgba(139,99,239,.18)",
    blob: "rgba(139,99,239,.22)",
    accent: "#5a34c2",
    bar: "linear-gradient(90deg,#8b63ef,#a64fd6)",
  },
  "resin-art": {
    panel: "linear-gradient(135deg,#f3f1fe 0%,#eaeefb 100%)",
    border: "rgba(122,79,240,.18)",
    blob: "rgba(122,79,240,.22)",
    accent: "#5733c9",
    bar: "linear-gradient(90deg,#7a4ff0,#e57fc4)",
  },
  tshirts: {
    panel: "linear-gradient(135deg,#fff8f2 0%,#ffe9da 100%)",
    border: "rgba(247,181,138,.30)",
    blob: "rgba(247,181,138,.30)",
    accent: "#9a5a2a",
    bar: "linear-gradient(90deg,#f7b58a,#e57fc4)",
  },
};
...
function CategorySection({ cat }) {
  ...
  useEffect(() => {
    api.getByCategory(cat.id).then((list) => setItems(list.slice(0, 4)));
  }, [cat.id]);
    ...
    <section className="max-w-[1240px] mx-auto px-4 sm:px-5 py-6 sm:py-8">
      <div
        ...
        style={{
          ...
          boxShadow: "0 12px 40px -18px rgba(122,79,240,.28)",
        }}
      >
        ...
        <div className="relative flex items-end justify-between gap-4 flex-wrap mb-6">
          <div>
            <h2
              className="font-display text-[1.7rem] sm:text-4xl font-semibold leading-tight"
              style={{ color: "#2c2336" }}
            >
              {cat.name}
            </h2>
            <div
              className="h-[3px] w-11 rounded-full mt-3 mb-2.5"
