...
export default function Footer() {
  ...
  const waNumber =
    (settings?.whatsappNumber || "").replace(/\D/g, "") || DEFAULT_WA;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg,#321447 0%,#4a1d68 45%,#2a1840 100%)",
        }}
      />
      {/* soft glow blobs */}
      <div
        className="absolute -top-24 -left-16 w-72 h-72 rounded-full blur-3xl"
        style={{ background: "rgba(166,79,214,.25)" }}
      />
      <div
        className="absolute -bottom-24 right-0 w-72 h-72 rounded-full blur-3xl"
        style={{ background: "rgba(122,79,240,.22)" }}
      />
      ...
      <div className="relative">
        ...
        <div className="max-w-[1240px] mx-auto px-5 pt-12 pb-10 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <p className="font-display text-lg font-bold mt-3 text-white flex items-center gap-2">
              Dillora by
              <img
                src="/unnamed.png"
                alt="Kashvin logo"
            ...
            >
              Handmade phone covers, charms, crochet, resin art and oversize
              tees made to order, with care, in India.
            </p>
            <div className="flex items-center gap-2 mt-4">
              <a
                ...
                className="inline-flex items-center justify-center w-9 h-9 rounded-full hover:scale-110 transition-transform duration-200"
                style={{ background: "rgba(255,255,255,.1)" }}
              >
                <InstagramIcon className="w-[18px] h-[18px] block" />
              </a>
              <a
                href="mailto:support@kashvin.in"
                aria-label="Email"
                className="inline-flex items-center justify-center w-9 h-9 rounded-full hover:scale-110 transition-transform duration-200"
                style={{ background: "rgba(255,255,255,.1)" }}
              >
            ...
            <ul className="space-y-2 list-none p-0 m-0">
              {categories.map((c) => (
                <li key={c.id}>
                  <Link
                    href={`/c/${c.id}`}
                    className="text-sm hover:pl-1 transition-all duration-200 inline-block"
          ...
          <div>
            ...
            <ul
              className="space-y-2.5 text-sm list-none p-0 m-0"
              style={{ color: "rgba(255,255,255,.75)" }}
            >
        ...
        >
          <div
            className="max-w-[1240px] mx-auto px-5 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs"
          ...
          >
            ...
            <span className="flex items-center gap-1.5">
              ...
              <Heart
                className="w-3 h-3"
                style={{ color: "#d4aeec", fill: "#d4aeec" }}
              />{" "}
